...
students, students' names, cohorts, cohorts' names, cohorts' starting dates, [list - function.]
```
...
| Record                | Properties          |
| --------------------- | ------------------  |
| Cohort                 | cohort_name, starting_date (student_id)
| Student                | student_name 


1. Name of the first table (always plural): `cohorts` 

    Column names: `cohort_name`, `starting_date`, 'student_id'
